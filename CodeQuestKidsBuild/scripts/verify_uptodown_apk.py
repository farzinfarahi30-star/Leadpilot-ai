#!/usr/bin/env python3
"""Fail-closed validator for the CodeQuest Kids Uptodown APK."""
...
EXPECTED_PACKAGE = "com.codequestkids.app"
EXPECTED_VERSION = "1.2.1"
EXPECTED_VERSION_CODE = "4"
EXPECTED_LABEL = "CodeQuest Kids"
EXPECTED_FILENAME = "CodeQuest-Kids-1.2.1-UPTODOWN-VERIFIED-V4.apk"
...
def main() -> int:
    ...
    print("CODEQUEST KIDS UPTODOWN APK VERIFIED")
