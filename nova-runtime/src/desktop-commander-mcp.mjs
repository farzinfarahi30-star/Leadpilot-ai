...
export async function desktopCommanderListTools(){return rpc('tools/list',{},1);}
export async function desktopCommanderCall(name,args={},id=2){return rpc('tools/call',{name,arguments:args},id);}
